...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int n = getNumerator();
		return construct((d * that.getNumerator()) + (n * that.getDenominator()), (d * that.getDenominator()));
	}
	...
	default IRational sub(IRational that) throws IllegalArgumentException {
		...
		int d = getDenominator();
		int n = getNumerator();
		return construct(n * that.getDenominator() - that.getNumerator() * d, d * that.getDenominator());
	}
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		int d = getDenominator();
		int n = getNumerator();
		return construct(n * that.getNumerator(), d * that.getDenominator());
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		...
		int d = getDenominator();
		int n = getNumerator();
		return construct(n * that.getDenominator(), d * that.getNumerator());
	}
}
